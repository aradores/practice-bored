        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Webhook Secret</th>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div>
                                    @if ($client->partner_secret == null)
                                        <button class="p-2 bg-red-600 rounded-md text-white"
                                            wire:click.stop="create_webhook_secret('{{ $client->id }}')"
                                            wire:confirm="Are you sure you create a webhook secret?">
                                            Add Webhook Secret
                                        </button>
                                    @endif
                                    <a class="p-2 bg-blue-600 rounded-md text-white"
                                        href="{{ route('sys.clients.ips', ['client_id' => $client->id]) }}">
                                        Show IPs
                                    </a>
                                </div>
                            </div>
