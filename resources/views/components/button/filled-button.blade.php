...
@php
    ...
    $colors = [
        ...
        'primary-reverse' => 'bg-white text-primary-600 hover:bg-rp-neutral-100 hover:text-primary-700',
        ...
        'danger' => 'text-white bg-red-600 border-red-600 hover:bg-red-700 hover:border-red-700 px-16 py-1 rounded-md', // New style added
        'primary-gradient' => 'bg-gradient-to-r from-[#7F56D9] from-[9.15%] to-[#B150C0] to-[135.76%] text-white hover:border-primary-600'
    ];
@endphp
