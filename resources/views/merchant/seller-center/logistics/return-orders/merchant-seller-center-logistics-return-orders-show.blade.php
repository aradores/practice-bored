            ...
            <div class="col-start-1 bg-white rounded-lg p-7">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <p class="text-rp-neutral-700 max-w-[230px] text-right font-bold">
                            {{ \Number::currency($return_order->product_order->transaction->amount + $return_order->product_order->transaction->service_fee, $return_order->product_order->transaction->currency) }}
                        </p>
                    </div>
                    <div class="flex justify-between">
