    ...
    <div>
        <x-table.rounded>
            <x-slot:table_header>
                ...
                <x-table.rounded.th class="w-40 max-w-40">Operating Days</x-table.rounded.th>
                <x-table.rounded.th class="w-96 max-w-96">Location</x-table.rounded.th>
                <x-table.rounded.th class="w-40 max-w-40">
            ...
            <x-slot:table_data>
                @foreach ($services as $key => $service)
                    ...
                    <x-table.rounded.row x-data="{
                            isMenuOpen: false
                        }" wire:key="service-{{ $key }}">
                        <x-table.rounded.td>
                            <div class="flex flex-row">
                                <div class="mr-4 overflow-hidden w-16 max-w-16 h-14 max-h-14">
                        ...
                        <x-table.rounded.td class="w-40 max-w-40">
                            {{ implode(', ', $service->service_days) }}
                        </x-table.rounded.td>
                        <x-table.rounded.td class="w-96 max-w-96">
