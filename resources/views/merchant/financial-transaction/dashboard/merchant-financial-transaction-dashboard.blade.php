<x-main.content x-data="data" class="bg-rp-neutral-100">
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="grid grid-cols-4 gap-3 2xl:gap-[23px]">
            <x-card.money-comparison-card title="Cashflow" :date="$dateFilter" :present="$cashflow" :past="$vsCashflow"
                color="white" :is_full="false" />
            <div class="flex flex-col flex-1 justify-center px-6 py-4 rounded-2xl bg-white">
                ...
                <span class="text-xl font-bold">{{ Number::currency($cashInTotal, 'PHP') }}</span>
            </div>
            <div class="flex flex-col flex-1 justify-center px-6 py-4 rounded-2xl bg-white">
                <p class="text-[19.2px]">Cash Outflow</p>
                <span class="text-3.5xl font-bold">{{ $cashOutCount }}</span>
                <span class="text-xl font-bold">{{ Number::currency($cashOutTotal, 'PHP') }}</span>
            </div>
            <div class="flex flex-col flex-1 justify-center px-6 py-4 rounded-2xl bg-white">
