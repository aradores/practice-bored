<div class="flex h-full" x-data="{ isAddItemVisible: $wire.entangle('isAddItemVisible'), isEditItemModalVisible: $wire.entangle('isEditItemModalVisible') }">
                ...
                <div>
                    <x-input.input-group>
                        ...
                        <div class="flex flex-row gap-2">
                            ...
                            <x-input type="tel" id="phone_number" wire:model.blur="phone_number" maxlength="15"
                ...
                <x-layout.summary.section color="{{ $is_admin ? 'primary' : 'red' }}" title="Summary">
                    <x-slot:data>
                        <x-layout.summary.label-data>
                            ...
                            <x-slot:data>
                                {{ Number::currency($this->total_items, 'PHP') }}
                            </x-slot:data>
                        </x-layout.summary.label-data>
                        <x-layout.summary.label-data>
                            <x-slot:label>
                            ...
                            <x-slot:data>
                                {{ Number::currency($this->inclusions, 'PHP') }}
                            </x-slot:data>
                        </x-layout.summary.label-data>
                        <x-layout.summary.label-data>
                            <x-slot:label>
                            ...
                            <x-slot:data class="{{ $is_admin ? '!text-primary-600' : '!text-rp-red-500' }}">
                                {{ Number::currency($this->total, 'PHP') }}
                            </x-slot:data>
                        </x-layout.summary.label-data>
                        @if ($allow_partial)
                            <x-layout.summary.label-data>
        ...
        <x-modal.form-modal title="Add Item">
            ...
            <div class="flex flex-row gap-2">
                <x-input.input-group class="w-1/2">
                    ...
                    <x-input type="number" placeholder="0" min="1" max="999999999" wire:model="new_item.quantity" />
    ...
    <div x-data="{ show: @entangle('apiSuccessMsg') }" x-cloak x-show="show"
        class="fixed inset-0 backdrop-blur-sm bg-black/50 z-50 flex items-center justify-center" @click="show = false">
