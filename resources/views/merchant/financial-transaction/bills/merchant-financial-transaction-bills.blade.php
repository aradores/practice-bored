<div class="flex w-full h-full">
    <x-main.content class="overflow-y-auto grow {{ $billDetails ? '!px-[18.5px]' : '' }}">
        ...
        <x-layout.sidebar-detail>
            ...
            <div class="w-full px-5 py-6 bg-white rounded-lg mt-7 text-rp-gray-800">
                ...
                <div class="text-sm text-center">
                    <div class="space-y-2">
                        @foreach ($billDetails->fields as $info)
                            <div>
                ...
                <div class="mt-6 text-sm text-center">
                    ...
                    <p>{{ $billDetails->created_at->timezone('Asia/Manila')->format('F d, Y - g:i A') }}</p>
                </div>
            </div>
            @if (!$billDetails->payment_date)
