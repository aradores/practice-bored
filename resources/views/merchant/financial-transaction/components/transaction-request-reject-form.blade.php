<x-modal.form-modal class="!text-rp-neutral-700 !w-[737px]" title="Reject {{ strtolower($request->type->name) }}?"
    subtitle="You are about to reject the {{ strtolower($request->type->name) }} transaction.">
    ...
    <p class="mt-3 text-rp-neutral-500 text-sm">Reason for cancellation</p>
    ...
    <x-slot:action_buttons>
        <div class="w-full flex justify-end gap-2">
            ...
            <x-button.filled-button color="red" class="!p-2.5 !border" wire:click="rejectRequest">
                Reject {{ $request->type->name }}
