                            ...
                            <div class="flex flex-col justify-center w-3/12 p-4">
                                <div class="flex flex-col gap-2">
                                    <div class="flex flex-row justify-between gap-1">
                                        ...
                                        <p>{{ \Number::currency($return_order->product_order->transaction->amount + $return_order->product_order->transaction->service_fee, $return_order->product_order->transaction->currency) }}</p>
                                    </div>
                                    {{-- <div class="flex flex-row justify-between gap-1">
