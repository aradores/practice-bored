<div>
    ...
    <div class="w-screen h-[40rem] bg-cover bg-no-repeat features-explore-background">
        <div class="h-full flex flex-col items-center justify-center">
            ...
            <p class="text-center w-[50%] tracking-wide text-lg">Explore the Best Philippine Real Estate Options! Working in tandem with RealHomes.ph, RePay affords users access to some of the finest listings in the local real estate market.</p>
        </div>
    </div>
