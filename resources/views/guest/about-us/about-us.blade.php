<div>
    ...
    <div class="flex flex-col sm:flex-row max-w-6xl mx-auto gap-12 py-12 px-9">
        ...
        <div class="flex-1">
            <div>
                <img src="{{ url('/images/guest/happy-family.png') }}" alt="Happy Family"/>
            </div>
        </div>  
    </div>
    ...
    <div class="flex flex-col-reverse sm:flex-row max-w-6xl mx-auto gap-12 py-12 px-9">
        ...
        <div class="flex-1">
            <div>
                <img src="{{ url('/images/guest/mother-and-baby.png') }}" alt="A mother is holding her baby in her arms while both look at a smartphone screen together."/>
            </div>
        </div>  
