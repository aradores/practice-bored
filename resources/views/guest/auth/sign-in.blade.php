            ...
            @elseif (empty($verification_id))
                ...
                <form @submit.prevent=""
                    ...
                    <x-input.input-group class="mb-6">
                        <x-slot:label for="username">Email address</x-slot:label>
                        <x-input type="text" id="username" wire:model.live="username"
                            placeholder="Type your email" class="{{ $errorMessage ? '!border-red-300' : '' }}">
                            <x-slot:icon>
                                <x-icon.user />
                            </x-slot:icon>
                        </x-input>
                ...
                <div
                    ...
                    <form @submit.prevent="submitPin" class="mt-16 w-full" x-data="pin">
                        ...
                        <div class="flex justify-center gap-4">
                            {{-- 1ST DIGIT --}}
                            <div class="">
                                <input x-ref="pin1" type="password" 
                            ...
                            {{-- 2ND DIGIT --}}
                            <div class="">
                                <input x-ref="pin2" type="password"  pattern="[0-9]"
                            ...
                            {{-- 3RD DIGIT --}}
                            <div class="">
                                <input x-ref="pin3" type="password"  pattern="[0-9]"
                            ...
                            {{-- 4TH DIGIT --}}
                            <div class="">
                                <input x-ref="pin4" type="password"  pattern="[0-9]"
