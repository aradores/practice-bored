                    ...
                    <x-table.rounded>
                        ...
                        <x-slot:table_data>
                            ...
                            @foreach ($cashInflows as $cash_inflow)
                                ...
                                @endphp
                                <x-table.rounded.row class="cursor-pointer {{ $isActiveRow ? 'border border-primary-600' : 'hover:bg-rp-neutral-50' }} "
                                    ...
                                    <x-table.rounded.td>{{ $cash_inflow->txn_no }}</x-table.rounded.td>
                                    <x-table.rounded.td>
