        ...
        @if ($return_order->status->name === 'Pending Resolution')    
            <div>
                ...
                <div class="flex flex-row gap-2">
                    <x-button.primary-gradient-button wire:click="$set('action','refund_only')" class="w-[162px] py-2.5">Refund Only</x-button.primary-gradient-button>
                    <x-button.primary-gradient-button wire:click="$set('action','return_only')" class="w-[162px] py-2.5">Return Only</x-button.primary-gradient-button>
                    <x-button.primary-gradient-button wire:click="$set('action','return_and_refund')" class="w-[162px] py-2.5">Return & Refund</x-button.primary-gradient-button>
                    <x-button.primary-gradient-button wire:click="$set('action','cancel')" class="w-[162px] py-2.5">Cancel</x-button.primary-gradient-button>
                </div>
            </div>
        @endif
    </div>
