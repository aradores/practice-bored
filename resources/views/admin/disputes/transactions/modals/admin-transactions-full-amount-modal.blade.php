<x-modal x-model="true">
    <x-modal.confirmation-modal class="!max-w-md" title="Pay Full Transaction Amount?" message="This action will refund the full amount of the transaction. The sender will be refunded a total of {{ \Number::currency($transactionAmount, $dispute->transaction->currency) }}.">
