    ...
    <table width="100%" style="font-family: 'Poppins', Arial, sans-serif;max-width:500px;word-break:break-word;margin:0 auto;">
        <tr>
            <td style="text-align:center;padding:12px 0;">
                <a href="{{ route('home') }}">
                    <img src="{{ $message->embed(public_path('images/repay-logo-colored.png')) }}" alt="Repay Logo">
                </a>
            </td>
        </tr>
        <tr>
                ...
                <table width="100%" style="padding:0;background-color:#ffff;border-radius:24px;">
                    <tr>
                        <td style="text-align:center;padding:16px;background-color:#9479D2;border-top-left-radius:24px;border-top-right-radius:24px;">
                            <h1 style="text-transform:uppercase;font-size:24px;font-weight:700;color:#ffff;margin:0;padding:0;">we have received</h1>
                            <h1 style="text-transform:uppercase;font-size:24px;font-weight:700;color:#ffff;margin:0;padding:0;">your inquiry!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:44px;color:#647887;">
                            <p style="padding:0;">Hi {{ $name }},</p>
                            <p style="padding:0;">Thank you for reaching out to us through our website! We’ve received your inquiry and our team is currently reviewing your message.
                            </p>
                            <p style="padding:0;">You can expect a response from us within 3-5 business days. In the meantime, if you have any additional questions or need further assistance, feel free to reply to this email or contact us at <a href="mailto:customer-support@repay.ph" style="color:inherit">customer-support@repay.ph</a>.
                            </p>
                            <p style="padding:0;">We appreciate your interest in RePay and look forward to assisting you.</p>
            ...
            <td>
                <table width="100%" style="padding:10px 0 0 0;font-size:12px;color:#647887;text-align:center;">
                    <tr>
                        <td>
                            <a href="{{ route('home') }}">
                                <img src="{{ $message->embed(public_path('images/repay-logo-colored.png')) }}" style="width:100px;" alt="Repay Logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
