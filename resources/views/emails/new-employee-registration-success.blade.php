                ...
                <table width="100%" style="padding:0;background-color:#ffff;border-radius:24px;">
                    ...
                    <tr>
                        <td style="padding:44px;color:#647887;">
                            ...
                            <p style="padding:0;">If you have any questions or need assistance, feel free to contact our support team at <a href="mailto:customer-support@repay.ph" style="color:inherit">customer-support@repay.ph</a>.
                            </p>
